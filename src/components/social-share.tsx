  ...
  return (
    <div className="social-share">
      ...
      <div className="social-share__links">
        ...
        >
          <svg className="social-share__instagram-logo" viewBox="0 0 24 24" width="19" height="19" aria-hidden="true">
        ...
        >
          <svg className="social-share__line-logo" viewBox="0 0 32 32" width="33" height="33" aria-hidden="true">
